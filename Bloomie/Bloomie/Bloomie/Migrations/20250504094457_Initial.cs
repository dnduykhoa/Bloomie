    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlowerTypeSuppliers", x => new { x.FlowerTypesId, x.SuppliersId });
                    table.ForeignKey(
                        name: "FK_FlowerTypeSuppliers_FlowerTypes_FlowerTypesId",
                        column: x => x.FlowerTypesId,
                        principalTable: "FlowerTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlowerTypeSuppliers_Suppliers_SuppliersId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FlowerTypeProducts", x => new { x.FlowerTypeId, x.ProductId });
                    table.ForeignKey(
                        name: "FK_FlowerTypeProducts_FlowerTypes_FlowerTypeId",
                        column: x => x.FlowerTypeId,
                        principalTable: "FlowerTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FlowerTypeProducts_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchFlowerTypes", x => new { x.BatchId, x.FlowerTypeId });
                    table.ForeignKey(
                        name: "FK_BatchFlowerTypes_Batches_BatchId",
                        column: x => x.BatchId,
                        principalTable: "Batches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BatchFlowerTypes_FlowerTypes_FlowerTypeId",
                        column: x => x.FlowerTypeId,
                        principalTable: "FlowerTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_FlowerTypes_FlowerTypeId",
                        column: x => x.FlowerTypeId,
                        principalTable: "FlowerTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchFlowerTypes_FlowerTypeId",
                table: "BatchFlowerTypes",
                column: "FlowerTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FlowerTypeProducts_ProductId",
                table: "FlowerTypeProducts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_FlowerTypeSuppliers_SuppliersId",
                table: "FlowerTypeSuppliers",
                column: "SuppliersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_FlowerTypeId",
                table: "InventoryTransactions",
                column: "FlowerTypeId");
